...
export const events = [
  ...
  { title: "Stratix", category: "Marketing", description: " A dynamic marketing challenge that inspres innovation, strategic thinking, and persuasive communication. Participants develop creative solutions, analyze market scenarios, and showcase the skills needed to craft impactful strategies in a competitive business landscape", eligibility: "Invited schools", teamSize: "Individual, 2 per school", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Trophy, banner: "nodes" },
