...
export const events = [
  ...
  { title: "Stratix", category: "Marketing", description: " A dynamic marketing challenge that inspres innovation, strategic thinking, and persuasive communication. Participants develop creative solutions, analyze market scenarios, and showcase the skills needed to craft impactful strategies in a competitive business landscape", teamSize: "Individual, 2 per school", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Trophy, banner: "nodes" },
  { title: "Metamorph", category: "Strategy", description: "A challenge that transforms discarded materials into extraodinary creations. It celebrates creativity, resourcefulness, and innovative thinking, encouraging participants to reimagine waste as opportunity and turn simple ideas into meaningful solutions.", teamSize: "3", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Palette, banner: "prism" },
  { title: "Chronoscope", category: "Creative", description: "A creative painting compeition that invites participants to visualize the world beyond today. Through imagination and artistic expression, they bring tomorrow's possibilities to life, transforming bold ideas into captivating works of art.", teamSize: "3", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Eye, banner: "lens" },
  { title: "Decktron", category: "Creative", description: "A presentation challenge that showcases the art of impactful storytelling through compelling slides and confident delivery. Participants combine creativity, clarity, and communication skills to transform ideas into engaging and memorable presentations.", teamSize: "2", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Presentation, banner: "deck" },
  { title: "Animatrix", category: "Creative", description: "An animation competition where imagination comes to life through motion and storytelling. Participants blend creativity, design, and technical skill to craft visually captivating animations that inspire, engage, and leave a lasting impression.", teamSize: "2", venue: "TBA", date: "06/08/2026", time: "TBA", icon: Camera, banner: "frames" },
];
